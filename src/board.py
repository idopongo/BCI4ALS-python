...
# HARDWARE_SETTINGS_MSG = "x1030110X x2030110X x3030110X x4030110X x5030110X x6030110X x7030110X x8030110X xQ030110X xW030110X xE030110X xR030110X xT030110X xY131000X xU131000X xI131000X "
HARDWARE_SETTINGS_MSG = "x1031000X x2031000X x3031000X x4031000X x5031000X x6031000X x7031000X x8031000X xQ031000X xW031000X xE031000X xR030110X xT030110X xY131000X xU131000X xI131000X "
NUM_CHANNELS_REMOVE = 3
# EEG_CHAN_NAMES = ["C3", "C4", "Cz", "FC1", "FC2", "FC5", "FC6", "CP1", "CP2", "CP5", "CP6", "O1", "O2"]
EEG_CHAN_NAMES = ["O1", "O2"]
...
class Board:
    ...
    def eeg_channels(self):
        return self.brainflow_board.get_eeg_channels(self.board_id)[-NUM_CHANNELS_REMOVE - 2:-NUM_CHANNELS_REMOVE]
